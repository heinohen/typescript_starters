...
function getSecondSmallest(inputArray: number[]): number {
...
console.log(
    getSecondSmallest([1,2,3,4,5]) + " expected 2" // 2
);
console.log(
    getSecondSmallest([5,4,3,2,1])  + " expected 2"// 2
);
console.log(
getSecondSmallest([3,6,5,4,3]) + " expected 4"// 4
);
console.log(
    getSecondSmallest([3,3,3,3,6,3]) + " expected 6"// 6
);
console.log(
    getSecondSmallest([1]) + " expected -999999"// -999999
);
console.log(
    getSecondSmallest([3,9]) + " expected 9"// 9
);
console.log(
    getSecondSmallest([-555,-333,-222,-111]) + " expected -333"// -333
);
